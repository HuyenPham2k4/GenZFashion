          ...
          <div class="col-lg-8">
            <div class="instagram__pic">
              <div
                  ...
                  style="background-image: url('../assets/img/instagram/instagram-1.jpg')"
              ></div>
              <div
                  class="instagram__pic__item set-bg"
                  style="background-image: url('../assets/img/instagram/instagram-2.jpg')"
              ></div>
              <div
                  class="instagram__pic__item set-bg"
                  style="background-image: url('../assets/img/instagram/instagram-3.jpg')"
              ></div>
              <div
                  class="instagram__pic__item set-bg"
                  style="background-image: url('../assets/img/instagram/instagram-4.jpg')"
              ></div>
              <div
                  class="instagram__pic__item set-bg"
                  style="background-image: url('../assets/img/instagram/instagram-5.jpg')"
              ></div>
              <div
                  class="instagram__pic__item set-bg"
                  style="background-image: url('../assets/../assets/img/instagram/instagram-6.jpg')"
              ></div>
            </div>
          </div>
          <div class="col-lg-4">
