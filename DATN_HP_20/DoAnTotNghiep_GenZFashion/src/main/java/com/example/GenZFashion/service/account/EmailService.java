package com.example.GenZFashion.service.account;

import com.example.GenZFashion.dto.ContactRequest;
import com.example.GenZFashion.dto.OrderLineDTO;
...
import com.example.GenZFashion.repository.auth.ContactRepository;
...
public class EmailService {
    ...
    public void sendOrderEmailByAdmin(
        ...
        for (Account admin : admins) {
            ...
            helper.setSubject("Thông báo đơn hàng từ GenZ Fashion");
    ...
    public void sendOtpEmail(String to, String otp) throws MessagingException {
        ...
        MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
        helper.setTo(to);
        helper.setSubject("Mã OTP xác thực quên mật khẩu GenZ Fashion");
