package com.example.GenZFashion.entity;
...
public class POSOrder {
    ...
    public POSOrder(Long ID, Customer customerID, String address, BigDecimal total_Amount, BigDecimal total_Payment, com.example.GenZFashion.entity.PaymentMethod paymentMethod, LocalDateTime creation_date, LocalDateTime edit_Date, Integer type_Oder, String note, Integer status) {
        this.ID = ID;
